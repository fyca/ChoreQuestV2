...
import com.lostsierra.chorequest.domain.models.RewardRedemptionsData
...
class RewardRepository @Inject constructor(
    ...
    fun createReward(reward: Reward): Flow<Result<Reward>> = flow {
        ...
        if (accessToken != null) {
            try {
                ...
                val rewardsData = readRewardsFromDrive(accessToken, folderId) ?: com.lostsierra.chorequest.domain.models.RewardsData(rewards = emptyList())
     ...
     */
    private suspend fun readRewardsFromDrive(accessToken: String, folderId: String): com.lostsierra.chorequest.domain.models.RewardsData? {
        return try {
            ...
            if (fileId != null) {
                ...
                gson.fromJson(jsonContent, com.lostsierra.chorequest.domain.models.RewardsData::class.java)
            } else {
                // File doesn't exist, return empty
                com.lostsierra.chorequest.domain.models.RewardsData(rewards = emptyList())
            }
        } catch (e: Exception) {
     ...
     */
    private suspend fun writeRewardsToDrive(accessToken: String, folderId: String, rewardsData: com.lostsierra.chorequest.domain.models.RewardsData): Boolean {
        return try {
            val fileName = "rewards.json"
