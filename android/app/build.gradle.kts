...
android {
    ...
    signingConfigs {
        getByName("debug") {
            ...
            // This config enables the signingReport task
        }
        
        create("release") {
            keystoreProperties?.let { props ->
                // Keystore file path is relative to android/ directory, so we need to go up one level from app/
                val keystoreFileName = props["storeFile"] as String
