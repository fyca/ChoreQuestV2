...
class ParentDashboardViewModel @Inject constructor(
            ...
            try {
                ...
                combine(
                    ...
                    val completedChores = chores.filter { 
                        it.status == com.lostsierra.chorequest.domain.models.ChoreStatus.COMPLETED 
                    }
    ...
    /**
     * Refresh dashboard data - triggers sync and reloads data
     */
    fun refresh() {
        viewModelScope.launch {
...
sealed class ParentDashboardState {
    ...
    data class Success(
        ...
        val pendingRewards: List<Triple<RewardRedemption, com.lostsierra.chorequest.domain.models.Reward, User>> = emptyList() // Pending reward redemptions with details
