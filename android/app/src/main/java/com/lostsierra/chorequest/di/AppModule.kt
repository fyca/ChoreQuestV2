...
import com.lostsierra.chorequest.data.remote.ChoreStatusDeserializer
import com.lostsierra.chorequest.data.remote.DeviceTypeDeserializer
import com.lostsierra.chorequest.data.remote.RewardRedemptionStatusDeserializer
import com.lostsierra.chorequest.data.remote.UserRoleDeserializer
...
object AppModule {
    ...
    fun provideGson(): Gson {
        return GsonBuilder()
            .setLenient()
            .registerTypeAdapter(UserRole::class.java, com.lostsierra.chorequest.data.remote.UserRoleTypeAdapter())
    ...
    fun provideRetrofit(
        ...
        val baseUrlString = com.lostsierra.chorequest.utils.Constants.APPS_SCRIPT_WEB_APP_URL
